...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 59, Name: permissions.RoleAssign},
		{ID: 60, Name: permissions.RoleAdd},
		{ID: 61, Name: permissions.RoleDelete},
		{ID: 62, Name: permissions.RoleReadAny},
		{ID: 63, Name: permissions.RoleReadOwn},
		{ID: 64, Name: permissions.TokenInviteAdminCreate},
		{ID: 65, Name: permissions.TokenInviteUserCreate},
		{ID: 66, Name: permissions.TokenInviteAdminDelete},
		{ID: 67, Name: permissions.TokenInviteUserDelete},
		{ID: 68, Name: permissions.StudentReadOther},
		{ID: 69, Name: permissions.StudentReadOwn},
		{ID: 70, Name: permissions.StudentClassroomReadAny},
		{ID: 71, Name: permissions.StudentClassroomReadOwn},
		{ID: 72, Name: permissions.StudentAdvisorReadAny},
		{ID: 73, Name: permissions.StudentAdvisorReadOwn},
		{ID: 74, Name: permissions.StudentParentReadAny},
		{ID: 75, Name: permissions.StudentParentReadOwn},
		{ID: 76, Name: permissions.InstitutionAdministratorReadOther},
		{ID: 77, Name: permissions.InstitutionAdministratorReadOwn},
		{ID: 78, Name: permissions.InstitutionAdministratorPositionAssign},
		{ID: 79, Name: permissions.InstitutionAdministratorPositionRead},
		{ID: 80, Name: permissions.StaffReadOther},
		{ID: 81, Name: permissions.StaffReadOwn},
		{ID: 82, Name: permissions.StaffPositionAssign},
		{ID: 83, Name: permissions.StaffPositionRead},
	}
	...
	teacherPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student.group.read.any", "student.group.read.own", "student.group.advisor.assign", "student.group.advisor.unassign", "student.group.advisor.read", "teacher.subject.read.any", "teacher.subject.read.own", "teacher.subject.add.own", "teacher.subject.assign.own", "teacher.subject.unassign.own", "teacher.classroom.read.any", "teacher.classroom.read.own", "teacher.classroom.assign.own", "teacher.classroom.unassign.own", "teacher.read.other", "teacher.read.own", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
