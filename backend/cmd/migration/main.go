...
func main() {
	...
	teacherPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student_group.read.any", "student_group.read.own", "student_group.advisor.assign", "student_group.advisor.unassign", "student_group.advisor.read", "teacher.subject.read.any", "teacher.subject.read.own", "teacher.subject.add.own", "teacher.subject.assign.own", "teacher.subject.unassign.own", "teacher.classroom.read.any", "teacher.classroom.read.own", "teacher.classroom.assign.own", "teacher.classroom.unassign.own", "teacher.read.other", "teacher.read.own", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
	...
	studentPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student_group.read.any", "student_group.read.own", "student_group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.read.own", "student.classroom.read.any", "student.advisor.read.any", "student.advisor.read.own", "student.parent.read.any", "student.parent.read.own", "student.classroom.read.own", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
