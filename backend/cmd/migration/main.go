...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 3, Name: permissions.PostReadVerified},
		{ID: 4, Name: permissions.PostReadOwn},
		{ID: 5, Name: permissions.PostUpdateAny},
		{ID: 6, Name: permissions.PostUpdateOwn},
		{ID: 7, Name: permissions.PostDeleteAny},
		{ID: 8, Name: permissions.PostDeleteOwn},
		{ID: 9, Name: permissions.PostVerify},
		{ID: 10, Name: permissions.PostMarkReturnedAny},
		{ID: 11, Name: permissions.PostMarkReturnedOwn},
		{ID: 12, Name: permissions.UserCreate},
		...
		{ID: 27, Name: permissions.RoomReadAny},
		{ID: 28, Name: permissions.RoomUpdate},
		{ID: 29, Name: permissions.RoomDelete},
		{ID: 30, Name: permissions.SubjectCreate},
		{ID: 31, Name: permissions.SubjectReadAny},
		{ID: 32, Name: permissions.SubjectUpdateAny},
		{ID: 33, Name: permissions.SubjectDeleteAny},
		...
		{ID: 69, Name: permissions.TokenInviteRead},
	}
