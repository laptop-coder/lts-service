...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 20, Name: permissions.RoomRead},
		{ID: 21, Name: permissions.RoomUpdate},
		{ID: 22, Name: permissions.RoomDelete},
		{ID: 23, Name: permissions.SubjectCreate},
		{ID: 24, Name: permissions.SubjectRead},
		{ID: 25, Name: permissions.SubjectUpdate},
		{ID: 26, Name: permissions.SubjectDelete},
		{ID: 27, Name: permissions.StudentGroupCreate},
		{ID: 28, Name: permissions.StudentGroupReadAny},
		{ID: 29, Name: permissions.StudentGroupReadOwn},
		{ID: 30, Name: permissions.StudentGroupUpdate},
		{ID: 31, Name: permissions.StudentGroupDelete},
		{ID: 32, Name: permissions.StudentGroupAdvisorAssign},
		{ID: 33, Name: permissions.StudentGroupAdvisorUnassign},
		...
		{ID: 37, Name: permissions.TeacherSubjectAssignAny},
		{ID: 38, Name: permissions.TeacherSubjectAssignOwn},
		{ID: 39, Name: permissions.TeacherSubjectUnassignAny},
		{ID: 40, Name: permissions.TeacherSubjectUnassignOwn},
		{ID: 41, Name: permissions.TeacherClassroomReadAny},
		{ID: 42, Name: permissions.TeacherClassroomReadOwn},
		{ID: 43, Name: permissions.TeacherClassroomAssignAny},
		{ID: 44, Name: permissions.TeacherClassroomAssignOwn},
		{ID: 45, Name: permissions.TeacherClassroomUnassignAny},
		{ID: 46, Name: permissions.TeacherClassroomUnassignOwn},
		{ID: 47, Name: permissions.TeacherReadOther},
		{ID: 48, Name: permissions.TeacherReadOwn},
		{ID: 49, Name: permissions.ParentStudentReadAny},
		{ID: 50, Name: permissions.ParentStudentReadOwn},
		{ID: 51, Name: permissions.ParentStudentAssignAny},
		{ID: 52, Name: permissions.ParentStudentAssignOwn},
		{ID: 53, Name: permissions.ParentStudentUnassignAny},
		{ID: 54, Name: permissions.ParentStudentUnassignOwn},
		{ID: 55, Name: permissions.ParentReadOther},
		{ID: 56, Name: permissions.ParentReadOwn},
		{ID: 57, Name: permissions.RoleAssign},
		{ID: 58, Name: permissions.RoleAdd},
		{ID: 59, Name: permissions.RoleDelete},
		{ID: 60, Name: permissions.RoleReadAny},
		{ID: 61, Name: permissions.RoleReadOwn},
		{ID: 62, Name: permissions.TokenInviteAdminCreate},
		{ID: 63, Name: permissions.TokenInviteUserCreate},
		{ID: 64, Name: permissions.TokenInviteAdminDelete},
		{ID: 65, Name: permissions.TokenInviteUserDelete},
		{ID: 66, Name: permissions.StudentReadOther},
		{ID: 67, Name: permissions.StudentReadOwn},
		{ID: 68, Name: permissions.StudentClassroomReadAny},
		{ID: 69, Name: permissions.StudentClassroomReadOwn},
		{ID: 70, Name: permissions.StudentAdvisorReadAny},
		{ID: 71, Name: permissions.StudentAdvisorReadOwn},
		{ID: 72, Name: permissions.StudentParentReadAny},
		{ID: 73, Name: permissions.StudentParentReadOwn},
		{ID: 74, Name: permissions.InstitutionAdministratorReadOther},
		{ID: 75, Name: permissions.InstitutionAdministratorReadOwn},
		{ID: 76, Name: permissions.InstitutionAdministratorPositionAssign},
		{ID: 77, Name: permissions.InstitutionAdministratorPositionRead},
		{ID: 78, Name: permissions.StaffReadOther},
		{ID: 79, Name: permissions.StaffReadOwn},
		{ID: 80, Name: permissions.StaffPositionAssign},
		{ID: 81, Name: permissions.StaffPositionRead},
	}
	...
	institutionAdministratorPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student.group.read.any", "student.group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.read.own", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
	...
	teacherPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student.group.read.any", "student.group.read.own", "student.group.advisor.assign", "student.group.advisor.unassign", "student.group.advisor.read", "teacher.subject.read.any", "teacher.subject.read.own", "teacher.subject.assign.own", "teacher.subject.unassign.own", "teacher.classroom.read.any", "teacher.classroom.read.own", "teacher.classroom.assign.own", "teacher.classroom.unassign.own", "teacher.read.other", "teacher.read.own", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}

	parentPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student.group.read.any", "student.group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.student.read.own", "parent.student.assign.own", "parent.student.unassign.own", "parent.read.other", "parent.read.own", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
