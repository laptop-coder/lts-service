...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 54, Name: permissions.TeacherReadOther},
		...
		{ID: 62, Name: permissions.RoleAssign},
		{ID: 63, Name: permissions.RoleAdd},
		{ID: 64, Name: permissions.RoleDelete},
		{ID: 65, Name: permissions.RoleReadAny},
		{ID: 66, Name: permissions.RoleReadOwn},
		{ID: 67, Name: permissions.TokenInviteAdminCreate},
		{ID: 68, Name: permissions.TokenInviteUserCreate},
		{ID: 69, Name: permissions.TokenInviteAdminDelete},
		{ID: 70, Name: permissions.TokenInviteUserDelete},
		{ID: 71, Name: permissions.StudentReadOther},
		{ID: 72, Name: permissions.InstitutionAdministratorReadOther},
		{ID: 73, Name: permissions.InstitutionAdministratorPositionAssign},
		{ID: 74, Name: permissions.InstitutionAdministratorPositionRead},
		{ID: 75, Name: permissions.StaffReadOther},
		{ID: 76, Name: permissions.StaffPositionAssign},
		{ID: 77, Name: permissions.StaffPositionRead},
	}
