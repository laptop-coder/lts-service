...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 20, Name: permissions.RoomUpdate},
		{ID: 21, Name: permissions.RoomDelete},
		{ID: 22, Name: permissions.SubjectCreate},
		{ID: 23, Name: permissions.SubjectUpdate},
		{ID: 24, Name: permissions.SubjectDelete},
		{ID: 25, Name: permissions.StudentGroupCreate},
		{ID: 26, Name: permissions.StudentGroupUpdate},
		{ID: 27, Name: permissions.StudentGroupDelete},
		{ID: 28, Name: permissions.StudentGroupAdvisorAssign},
		{ID: 29, Name: permissions.StudentGroupAdvisorUnassignAny},
		{ID: 30, Name: permissions.StudentGroupAdvisorUnassignOwn},
		{ID: 31, Name: permissions.StudentGroupAdvisorRead},
		{ID: 32, Name: permissions.TeacherSubjectReadAny},
		{ID: 33, Name: permissions.TeacherSubjectReadOwn},
		{ID: 34, Name: permissions.TeacherSubjectAddAny},
		{ID: 35, Name: permissions.TeacherSubjectAddOwn},
		{ID: 36, Name: permissions.TeacherSubjectAssignAny},
		{ID: 37, Name: permissions.TeacherSubjectAssignOwn},
		{ID: 38, Name: permissions.TeacherSubjectUnassignAny},
		{ID: 39, Name: permissions.TeacherSubjectUnassignOwn},
		{ID: 40, Name: permissions.TeacherClassroomReadAny},
		{ID: 41, Name: permissions.TeacherClassroomReadOwn},
		{ID: 42, Name: permissions.TeacherClassroomAssignAny},
		{ID: 43, Name: permissions.TeacherClassroomAssignOwn},
		{ID: 44, Name: permissions.TeacherClassroomUnassignAny},
		{ID: 45, Name: permissions.TeacherClassroomUnassignOwn},
		{ID: 46, Name: permissions.TeacherReadOther},
		{ID: 47, Name: permissions.TeacherReadOwn},
		{ID: 48, Name: permissions.TeacherStudentGroupReadOwn},
		{ID: 49, Name: permissions.ParentStudentReadAny},
		{ID: 50, Name: permissions.ParentStudentReadOwn},
		{ID: 51, Name: permissions.ParentStudentAddAny},
		{ID: 52, Name: permissions.ParentStudentAddOwn},
		...
		{ID: 57, Name: permissions.ParentStudentGroupReadOwn},
		{ID: 58, Name: permissions.RoleAdminAssign},
		{ID: 59, Name: permissions.RoleUserAssign},
		{ID: 60, Name: permissions.RoleAdminAdd},
		{ID: 61, Name: permissions.RoleUserAdd},
		{ID: 62, Name: permissions.RoleAdminUnassign},
		{ID: 63, Name: permissions.RoleUserUnassign},
		...
		{ID: 88, Name: permissions.PositionInstitutionAdministratorUpdate},
		{ID: 89, Name: permissions.PositionInstitutionAdministratorDelete},
	...
	adminPermissions := []string{
		"post.create", "post.read.any", "post.read.own", "post.update.any", "post.update.own", "post.delete.any", "post.delete.own", "post.photo.delete.any", "post.photo.delete.own", "post.photo.update.any", "post.photo.update.own", "post.verify", "post.mark.returned.any", "post.mark.returned.own", "conversation.create", "conversation.read.own", "conversation.message.send", "conversation.message.mark_as_read", "user.read.own", "user.read.other", "user.read.all", "user.update.own", "user.delete.any.user", "user.delete.own", "room.create", "room.update", "room.delete", "subject.create", "subject.update", "subject.delete", "student_group.create", "student_group.update", "student_group.delete", "student_group.advisor.assign", "student_group.advisor.unassign.any", "student_group.advisor.read", "teacher.subject.read.any", "teacher.subject.add.any", "teacher.subject.assign.any", "teacher.subject.unassign.any", "teacher.classroom.read.any", "teacher.classroom.assign.any", "teacher.classroom.unassign.any", "teacher.read.other", "parent.student.read.any", "parent.student.add.any", "parent.student.unassign.any", "parent.read.other", "role.user.assign", "role.user.add", "role.user.unassign", "role.read.any", "role.read.own", "token.invite.user.create", "token.invite.user.delete", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.assign", "institution_administrator.position.read", "staff.read.other", "staff.position.assign", "staff.position.read", "position.institution_administrator.create", "position.institution_administrator.update", "position.institution_administrator.delete", "position.staff.create", "position.staff.update", "position.staff.delete",
	}

	institutionAdministratorPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.photo.update.own", "post.mark.returned.own", "conversation.create", "conversation.read.own", "conversation.message.send", "conversation.message.mark_as_read", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "student_group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.read.own", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
