...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 32, Name: permissions.StudentGroupAdvisorUnassign},
		{ID: 33, Name: permissions.StudentGroupAdvisorRead},
		{ID: 34, Name: permissions.TeacherSubjectReadAny},
		{ID: 35, Name: permissions.TeacherSubjectReadOwn},
		{ID: 36, Name: permissions.TeacherSubjectAddAny},
		{ID: 37, Name: permissions.TeacherSubjectAddOwn},
		{ID: 38, Name: permissions.TeacherSubjectAssignAny},
		{ID: 39, Name: permissions.TeacherSubjectAssignOwn},
		{ID: 40, Name: permissions.TeacherSubjectUnassignAny},
		{ID: 41, Name: permissions.TeacherSubjectUnassignOwn},
		{ID: 42, Name: permissions.TeacherClassroomReadAny},
		{ID: 43, Name: permissions.TeacherClassroomReadOwn},
		{ID: 44, Name: permissions.TeacherClassroomAssignAny},
		{ID: 45, Name: permissions.TeacherClassroomAssignOwn},
		{ID: 46, Name: permissions.TeacherClassroomUnassignAny},
		{ID: 47, Name: permissions.TeacherClassroomUnassignOwn},
		{ID: 48, Name: permissions.TeacherReadOther},
		{ID: 49, Name: permissions.TeacherReadOwn},
		...
		{ID: 58, Name: permissions.ParentReadOwn},
		{ID: 59, Name: permissions.ParentStudentGroupReadOwn},
		{ID: 60, Name: permissions.RoleAssign},
		{ID: 61, Name: permissions.RoleAdd},
		{ID: 62, Name: permissions.RoleDelete},
		{ID: 63, Name: permissions.RoleReadAny},
		{ID: 64, Name: permissions.RoleReadOwn},
		{ID: 65, Name: permissions.TokenInviteAdminCreate},
		{ID: 66, Name: permissions.TokenInviteUserCreate},
		{ID: 67, Name: permissions.TokenInviteAdminDelete},
		{ID: 68, Name: permissions.TokenInviteUserDelete},
		{ID: 69, Name: permissions.StudentReadOther},
		{ID: 70, Name: permissions.StudentReadOwn},
		{ID: 71, Name: permissions.StudentClassroomReadAny},
		{ID: 72, Name: permissions.StudentClassroomReadOwn},
		{ID: 73, Name: permissions.StudentAdvisorReadAny},
		{ID: 74, Name: permissions.StudentAdvisorReadOwn},
		{ID: 75, Name: permissions.StudentParentReadAny},
		{ID: 76, Name: permissions.StudentParentReadOwn},
		{ID: 77, Name: permissions.StudentStudentGroupReadOwn},
		{ID: 78, Name: permissions.InstitutionAdministratorReadOther},
		{ID: 79, Name: permissions.InstitutionAdministratorReadOwn},
		{ID: 80, Name: permissions.InstitutionAdministratorPositionAssign},
		{ID: 81, Name: permissions.InstitutionAdministratorPositionRead},
		{ID: 82, Name: permissions.StaffReadOther},
		{ID: 83, Name: permissions.StaffReadOwn},
		{ID: 84, Name: permissions.StaffPositionAssign},
		{ID: 85, Name: permissions.StaffPositionRead},
	}
	...
	institutionAdministratorPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student_group.read.any", "student_group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.read.own", "institution_administrator.position.read", "staff.read.other", "staff.position.read",
	}
	...
	teacherPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student_group.read.any", "student_group.advisor.assign", "student_group.advisor.unassign", "student_group.advisor.read", "teacher.subject.read.any", "teacher.subject.read.own", "teacher.subject.add.own", "teacher.subject.assign.own", "teacher.subject.unassign.own", "teacher.classroom.read.any", "teacher.classroom.read.own", "teacher.classroom.assign.own", "teacher.classroom.unassign.own", "teacher.read.other", "teacher.read.own", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.classroom.read.any", "student.advisor.read.any", "student.parent.read.any", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read", "teacher.student_group.read.own",
	}
	...
	studentPermissions := []string{
		"post.create", "post.read.own", "post.update.own", "post.delete.own", "post.photo.delete.own", "post.mark.returned.own", "user.read.own", "user.read.other", "user.update.own", "user.delete.own", "room.read", "subject.read", "student_group.read.any", "student_group.advisor.read", "teacher.subject.read.any", "teacher.classroom.read.any", "teacher.read.other", "parent.read.other", "role.read.any", "role.read.own", "student.read.other", "student.read.own", "student.classroom.read.any", "student.advisor.read.any", "student.advisor.read.own", "student.parent.read.any", "student.parent.read.own", "student.classroom.read.own", "institution_administrator.read.other", "institution_administrator.position.read", "staff.read.other", "staff.position.read", "student.student_group.read.own",
	}
